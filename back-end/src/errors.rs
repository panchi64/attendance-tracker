...
pub enum AppError {
    ...
    Unauthorized(String), // Use Forbidden status code
...
impl ResponseError for AppError {
    fn status_code(&self) -> StatusCode {
        match self {
            AppError::SqlxError(e) => match e { // Need to inspect inner error again
            ...
            AppError::CsvError(_) => StatusCode::INTERNAL_SERVER_ERROR,
    ...
    fn error_response(&self) -> HttpResponse {
        ...
        let (error_code, error_message) = match self {
            ...
            AppError::Unauthorized(message) => ("forbidden", message.clone()),
